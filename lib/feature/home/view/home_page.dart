...
import 'package:rappipay_test/feature/home/view/home_desktop.dart';
import 'package:rappipay_test/feature/home/view/home_mobile.dart';
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          return MediaQuery.of(context).size.width > 900
              ? HomeDesktop(child: child)
              : HomeMobile(child: child);
        },
      ),
    );
  }
